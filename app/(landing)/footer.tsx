        ...
        <footer className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                <Link
                    ...
                    <span className="text-xl font-medium">AI Image Studio</span>
                </Link>

                <div className="my-8 flex flex-wrap justify-center gap-4 sm:gap-6">
                    <Link
                        href="/"
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} AI Image Studio, All rights reserved</span>
            </div>
        </footer>
    )
}
