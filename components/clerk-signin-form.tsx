...
export function ClerkSignInForm({ onSuccess, onSignUpClick }: ClerkSignInFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.status === 'complete') {
        ...
        setError('Additional verification required. Please check your authenticator app.')
      } else {
